    ...
    string? endpoint = null) : IQChatImageRecognitionClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        using HttpRequestMessage httpRequest = new(HttpMethod.Post, ResolveEndpoint());
    ...
    Uri ResolveEndpoint()
    {
        string configured = string.IsNullOrWhiteSpace(endpoint) ? DefaultEndpoint : endpoint.Trim();
