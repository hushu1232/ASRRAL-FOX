...
We need a single, predictable wire format for the Next.js API routes consumed by the React frontend and the Alife WebBridge client.
...
- Frontend components and the Alife WebBridge client consume snake_case keys
