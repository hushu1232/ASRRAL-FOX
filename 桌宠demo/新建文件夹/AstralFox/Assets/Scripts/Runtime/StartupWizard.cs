...
namespace AstralFox
{
    ...
    public sealed class StartupWizard : MonoBehaviour
    {
        ...
        private static readonly string[] ModelNames = {
            "CatTail (猫尾)", "AK-12 (少女前线)", "M4A1 (少女前线)",
            "Enterprise (碧蓝航线)", "Belfast (碧蓝航线)", "Atago (碧蓝航线)", "Akagi (碧蓝航线)"
        };
        ...
        private void OnGUI()
        {
            ...
            // Background panel
            GUI.Box(box, "", new GUIStyle(GUI.skin.box)
            {
                normal = { background = MakeColorTexture(new Color(0.15f, 0.12f, 0.2f, 0.95f)) },
            });
        ...
        private void DrawModelSelect()
        {
            ...
            _selectedModelIndex = GUILayout.SelectionGrid(_selectedModelIndex, ModelNames, 2, GUILayout.Height(120));
